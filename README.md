...
```bash
# start master1
cargo run --release  --features iouring --bin helyim -- master --peers 1:127.0.0.1:8333 --peers 1:127.0.0.1:8333 --peers 1:127.0.0.1:8335 --port 9333
# start master2
cargo run --release  --features iouring --bin helyim -- master --peers 1:127.0.0.1:8334 --peers 1:127.0.0.1:8333 --peers 1:127.0.0.1:8335 --port 9335
# start master3
cargo run --release  --features iouring --bin helyim -- master --peers 1:127.0.0.1:8335 --peers 1:127.0.0.1:8333 --peers 1:127.0.0.1:8335 --port 9337
```
