...
pub fn write_sorted_file_from_idx(base_filename: &str, ext: &str) -> Result<()> {
...
pub fn write_ec_files(base_filename: &str) -> Result<()> {
    generate_ec_files(
        base_filename,
        256 * 1024,
...
pub fn rebuild_ec_files(base_filename: &str) -> Result<Vec<u32>> {
...
fn generate_missing_ec_files(base_filename: &str) -> Result<Vec<u32>> {
...
fn open_ec_files(base_filename: &str, readonly: bool) -> Result<Vec<File>> {
