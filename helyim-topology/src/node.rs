    ...
    ($node:ident) => {
        ...
        impl crate::node::Node for $node {
            ...
            fn reserve_one_volume(
                &self,
                rand: i64,
            ) -> StdResult<crate::DataNodeRef, crate::topology::TopologyError> {
...
#[cfg(test)]
mod tests {
    use crate::{node::Node, topology::tests::setup_topo};
